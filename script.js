...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (video) {
        ...
        // Fade-in dès que la vidéo peut commencer à jouer
        video.addEventListener('canplay', () => {
            video.classList.add('loaded');
            tryPlay();
        }, { once: true });

        // Fallback : si canplay ne se déclenche pas dans 4s, afficher quand même
        setTimeout(() => { video.classList.add('loaded'); tryPlay(); }, 4000);
